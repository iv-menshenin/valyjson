...
// jsonParserTestInh01used for pooling Parsers for TestInh01 JSONs.
...
func (s *TestInh01) FillFromJson(v *fastjson.Value, objPath string) (err error) {
	...
	if testinh02 := v.Get("injected"); testinh02 != nil {
		var valTestInh02 TestInh02
		err = valTestInh02.FillFromJson(testinh02, objPath+"injected.")
		if err != nil {
	...
	if random := v.Get("random"); random != nil {
		var valRandom int
		valRandom, err = random.Int()
		if err != nil {
	...
	if nested1 := v.Get("nested1"); nested1 != nil {
		var valNested1 TestInh03
		err = valNested1.FillFromJson(nested1, objPath+"nested1.")
		if err != nil {
			return fmt.Errorf("error parsing '%snested1' value: %w", objPath, err)
		}
		s.Nested1 = TestInh03(valNested1)
	}
	if nested2 := v.Get("nested2"); valueIsNotNull(nested2) {
		var valNested2 TestInh03
		err = valNested2.FillFromJson(nested2, objPath+"nested2.")
		if err != nil {
...
// jsonParserTestInh02used for pooling Parsers for TestInh02 JSONs.
...
// jsonParserTestInh03used for pooling Parsers for TestInh03 JSONs.
...
// jsonParserTestInh04used for pooling Parsers for TestInh04 JSONs.
...
func (s *TestInh04) FillFromJson(v *fastjson.Value, objPath string) (err error) {
	...
	if foobar := v.Get("foo-bar"); foobar != nil {
		var valFooBar int
		valFooBar, err = foobar.Int()
		if err != nil {
