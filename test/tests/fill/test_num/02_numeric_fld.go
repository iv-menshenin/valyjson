...
type NumStruct01 struct {
	...
	RefIntFld8    *int8    `json:"ref_int_fld8,omitempty"`
	...
	RefUintFld8   *uint8   `json:"ref_Uint_fld8,omitempty"`
...
// NumStruct02 tests strict struct generation
//json:strict
